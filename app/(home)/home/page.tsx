      ...
      <Card className="relative overflow-hidden border-2 border-blue-500/30 bg-linear-to-br from-blue-500/10 via-blue-500/5 to-blue-500/10 mb-8 md:mb-12 group hover:shadow-xl hover:border-blue-500/50 transition-all duration-300">
        ...
        <CardContent className="relative z-10 p-6 md:p-8">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              <div className="shrink-0">
                <div className="relative">
                  ...
                  <div className="relative p-4 rounded-xl bg-linear-to-br from-blue-500/20 to-blue-500/10 border border-blue-500/30">
              ...
              <div className="flex-1 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-blue-500">Featured Tool</span>
                </div>
                <h2 className="text-2xl md:text-3xl font-bold tracking-tight">
                  Gmail Deliverability Viewer
                </h2>
                <p className="text-muted-foreground text-base md:text-lg leading-relaxed max-w-2xl">
                  Analyze email placement, inspect headers for sending IPs and domains, and verify where your emails land in Gmail (Primary, Promotions, Spam, Social) — all without storing email bodies.
                </p>
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  ...
                  >
                    <Link href="/gmail-deliverability" className="flex items-center gap-2">
            ...
            {/* How to Use Guide */}
            <div className="border-t border-blue-500/20 pt-6 mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* Step 1 */}
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background/50 border border-blue-500/10 hover:border-blue-500/30 transition-colors">
                  <div className="shrink-0 w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-500 font-bold text-sm">
                    1
                  </div>
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm mb-1">Connect Gmail</h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      Click "Connect Gmail Account" and authorize read-only access. Your tokens are encrypted and stored securely.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background/50 border border-blue-500/10 hover:border-blue-500/30 transition-colors">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm mb-1">Search Inbox</h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      Select an inbox, enter a search query (subject, from, etc.), and filter by label to find specific emails.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background/50 border border-blue-500/10 hover:border-blue-500/30 transition-colors">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm mb-1">Analyze Results</h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      View email placement, sending IP, sending domain, and other deliverability metadata to optimize your campaigns.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-blue-500/10">
                <div className="flex flex-wrap items-center gap-4 text-sm">
                  <div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    <span>Share inboxes with colleagues</span>
                  </div>
                  <div className="flex items-center gap-2 text-muted-foreground">
                    <CheckCircle2 className="h-4 w-4 text-blue-500" />
                    <span>No email bodies stored</span>
                  </div>
                  <div className="flex items-center gap-2 text-muted-foreground">
                    <CheckCircle2 className="h-4 w-4 text-blue-500" />
              ...
              {/* Security & Sharing Info */}
              <div className="mt-4 pt-4 border-t border-blue-500/10">
                <div className="flex items-start gap-3 p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
                  <Shield className="h-5 w-5 text-blue-500 shrink-0 mt-0.5" />
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm mb-1 text-blue-600 dark:text-blue-400">
                      Secure Team Access
                    </h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      Grant your team members access to view inbox metadata without sharing passwords. 
                      Simply add their email address and they'll be able to search and analyze emails 
                      for deliverability insights. You maintain full control and can revoke access anytime.
                    </p>
                  </div>
                </div>
              </div>
